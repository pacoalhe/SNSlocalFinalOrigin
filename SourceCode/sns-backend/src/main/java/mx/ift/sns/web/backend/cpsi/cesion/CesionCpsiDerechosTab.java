...
public class CesionCpsiDerechosTab extends TabWizard {

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(CesionCpsiDerechosTab.class);
     ...
     */
    public CesionCpsiDerechosTab(Wizard pWizard, ICodigoCPSIFacade pCodigoCpsiFacade) {
        ...
        this.codigoCpsiFacade = pCodigoCpsiFacade;
    }
    ...
    public void cargaValoresIniciales() {
        try {
            ...
            listaProveedoresCedentes = codigoCpsiFacade.findAllProveedoresActivos();
            listaProveedoresCesionarios = codigoCpsiFacade.findAllProveedoresActivos();
    ...
    public void seleccionPstCedente() {
        try {
            ...
            if (solicitud.getProveedorSolicitante() != null) {
                listaRepresentantesLegalesPstCedente = codigoCpsiFacade.getRepresentantesLegales(
                        TipoContacto.REPRESENTANTE_LEGAL, solicitud.getProveedorSolicitante().getId());
                listaRepresentantesSuplentesPstCedente = codigoCpsiFacade.getRepresentantesLegales(
    ...
    public void seleccionPstCesionario() {
        try {
            if (solicitud.getProveedorCesionario() != null) {
                listaRepresentantesLegalesPstCesionario = codigoCpsiFacade.getRepresentantesLegales(
                        TipoContacto.REPRESENTANTE_LEGAL, solicitud.getProveedorCesionario().getId());
                listaRepresentantesSuplentesPstCesionario = codigoCpsiFacade.getRepresentantesLegales(
