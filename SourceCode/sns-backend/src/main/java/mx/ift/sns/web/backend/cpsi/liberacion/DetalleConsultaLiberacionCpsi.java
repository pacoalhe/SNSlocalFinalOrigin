...
/**
 * Representa la información de consulta de una solicitud de liberación CPSI adaptada al front.
 */
public class DetalleConsultaLiberacionCpsi implements Serializable {
