...
/** Clase de soporte para la pestaña de 'Generales' para el trámite de Liberaciones CPSI en los Wizard. */
public class GeneralesLiberacionCpsiTab extends TabWizard {

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(GeneralesLiberacionCpsiTab.class);
    ...
    private ICodigoCPSIFacade cpsnFacade;
     ...
     * @param pCpsnFacade Facade de Servicios de CPSI
     */
    public GeneralesLiberacionCpsiTab(Wizard pWizard, ICodigoCPSIFacade pCpsnFacade) {
        ...
        if (isValido()) {
            try {
                ...
                if (solicitud.getTipoSolicitud() == null) {
                    ...
                    tipoSol.setCdg(TipoSolicitud.LIBERACION_CPSI);
     ...
     */
    public SolicitudLiberacionCpsi getSolicitud() {
        return solicitud;
    }
