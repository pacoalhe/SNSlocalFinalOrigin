...
/** Clase de soporte para la pestaña de 'CesionDerechos' de la cesión de derechos CPSN del Wizard. */
public class CesionCPSNDerechosTab extends TabWizard {
    ...
    private ICodigoCPSNFacade codigosCPSNFacade;

    /** Solicitud de Cesion CPSN. */
    ...
    /**
     * Constructor de la clase de respaldo para el tab/pestaña de 'CesionDerechos' CPSN.
     * @param pWizard Referencia a la clase Wizard que instancia este Tab
     * @param codigoCPSNFacade Facade de códigos de señalización nacionales
     */
    public CesionCPSNDerechosTab(Wizard pWizard, ICodigoCPSNFacade codigoCPSNFacade) {
        ...
        this.codigosCPSNFacade = codigoCPSNFacade;
    }
    ...
    public void cargaValoresIniciales() {
        try {
            ...
            listaProveedoresCedentes = codigosCPSNFacade.findAllProveedoresActivos();
            listaProveedoresCesionarios = codigosCPSNFacade.findAllProveedoresActivos();
    ...
    public void seleccionPstCedente() {
        try {
            ...
            if (solicitud.getProveedorSolicitante() != null) {
                listaRepresentantesLegalesPstCedente = codigosCPSNFacade.getRepresentantesLegales(
                        TipoContacto.REPRESENTANTE_LEGAL, solicitud.getProveedorSolicitante().getId());
                listaRepresentantesSuplentesPstCedente = codigosCPSNFacade.getRepresentantesLegales(
    ...
    public void seleccionPstCesionario() {
        try {
            if (solicitud.getProveedorCesionario() != null) {
                listaRepresentantesLegalesPstCesionario = codigosCPSNFacade.getRepresentantesLegales(
                        TipoContacto.REPRESENTANTE_LEGAL, solicitud.getProveedorCesionario().getId());
                listaRepresentantesSuplentesPstCesionario = codigosCPSNFacade.getRepresentantesLegales(
    ...
    public void actualizaCampos() {
        try {
            ...
            if (!solicitud.getEstadoSolicitud().getCodigo().equals(EstadoSolicitud.SOLICITUD_CANCELADA)) {
                this.setTabHabilitado(solicitud.getCesionesSolicitadasCPSN().isEmpty());
            }
    ...
    private boolean guardarCambios() {
        try {
            if (isValido()) {
                ...
                solicitud = codigosCPSNFacade.saveSolicitudCesion(solicitud);
    ...
    private boolean isValido() {
        try {
            ...
            // PST Cedente y PST Cesionarios distintos
            if (solicitud.getProveedorSolicitante().equals(solicitud.getProveedorCesionario())) {
                MensajesBean.addErrorMsg(MSG_ID, "El Proveedor Cedente y Cesionario no pueden ser el mismo.", "");
                return false;
            }
    ...
    /**
     * Muestra los campos de identificación de un Proveedor de Tipo 'Comercializadora'.
     * @param pstComercializadora boolean
     */
    ...
    /**
     * Muestra los campos de identificación de un Proveedor de Tipo 'Concesionario'.
     * @param pstConcesionario boolean
     */
    ...
    /**
     * Lista de Representantes legales asociados al Proveedor Cedente.
     * @param listaRepresentantesLegalesPstCedente List<Contacto>
     */
    public void setListaRepresentantesLegalesPstCedente(List<Contacto> listaRepresentantesLegalesPstCedente) {
        this.listaRepresentantesLegalesPstCedente = listaRepresentantesLegalesPstCedente;
    }
    ...
    /**
     * Lista de Representantes suplentes asociados al Proveedor Cedente.
     * @param listaRepresentantesSuplentesPstCedente List<Contacto>
     */
    public void setListaRepresentantesSuplentesPstCedente(List<Contacto> listaRepresentantesSuplentesPstCedente) {
        this.listaRepresentantesSuplentesPstCedente = listaRepresentantesSuplentesPstCedente;
    }
    ...
    /**
     * Lista de Representantes legales asociados al Proveedor Cesionario.
     * @param listaRepresentantesLegalesPstCesionario List<Contacto>
     */
    public void setListaRepresentantesLegalesPstCesionario(List<Contacto> listaRepresentantesLegalesPstCesionario) {
        this.listaRepresentantesLegalesPstCesionario = listaRepresentantesLegalesPstCesionario;
    }
    ...
    /**
     * Lista de Representantes suplentes asociados al Proveedor Cesionario.
     * @param listaRepresentantesSuplentesPstCesionario List<Contacto>
     */
    public void setListaRepresentantesSuplentesPstCesionario(List<Contacto> listaRepresentantesSuplentesPstCesionario) {
        this.listaRepresentantesSuplentesPstCesionario = listaRepresentantesSuplentesPstCesionario;
    }
