...
/** Clase de soporte para la pestaña de 'Generales' para el trámite de Liberaciones CPSN en los Wizard. */
public class GeneralesLiberacionCpsnTab extends TabWizard {

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(GeneralesLiberacionCpsnTab.class);
     ...
     */
    public GeneralesLiberacionCpsnTab(Wizard pWizard, ICodigoCPSNFacade pCpsnFacade) {
        ...
        if (isValido()) {
            try {
                ...
                if (solicitud.getTipoSolicitud() == null) {
                    ...
                    tipoSol.setCdg(TipoSolicitud.LIBERACION_CPSN);
    ...
    public void actualizaCampos() {
        try {
            ...
            if (solicitud.isLiberacionIft() != null) {
                liberacionIft = solicitud.isLiberacionIft().booleanValue();
            }
    ...
    /**
     * Lista de proveedores disponibles para seleccionar.
     * @param listaProveedores Catálogo de proveedores
     */
     ...
     */
    public SolicitudLiberacionCpsn getSolicitud() {
        return solicitud;
    }
    ...
    /**
     * Lista de representantes legales del proveedor.
     * @param listaRepresentantes Catálogo de contactos asociado al Proveedor
     */
    ...
    /**
     * Lista de representantes suplentes del proveedor.
     * @param listaSuplentes Catálogo de contactos asociado al Proveedor
     */
