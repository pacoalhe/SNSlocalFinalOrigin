 ...
 */
public class SolicitudRedistNgLazyModel extends LazyDataModel<SolicitudRedistribucionNg> {

    /** Serialización. */
    private static final long serialVersionUID = 1L;

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(SolicitudRedistNgLazyModel.class);

    /** Colección de objetos. */
    private List<SolicitudRedistribucionNg> dataSource;
    ...
    /** Constructor. */
    public SolicitudRedistNgLazyModel() {
        dataSource = new ArrayList<SolicitudRedistribucionNg>(1);
    }

    @Override
    public SolicitudRedistribucionNg getRowData(String rowKey) {
        for (SolicitudRedistribucionNg solicitud : dataSource) {
    ...
    @Override
    public Object getRowKey(SolicitudRedistribucionNg pSolicitud) {
        return pSolicitud.getId().toString();
    }

    @Override
    public List<SolicitudRedistribucionNg> load(int first, int pageSize, String sortField, SortOrder sortOrder,
        ...
        try {
            ...
            dataSource.clear();
            dataSource.addAll(service.findAllSolicitudesRedistribucion(filtros));
