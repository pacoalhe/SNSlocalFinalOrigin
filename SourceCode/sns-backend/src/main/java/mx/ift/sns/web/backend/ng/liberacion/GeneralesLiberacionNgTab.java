...
/** Clase de soporte para la pestaña de 'Generales' para el trámite de Liberaciones NG en los Wizard. */
public class GeneralesLiberacionNgTab extends TabWizard {

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(GeneralesLiberacionNgTab.class);
    ...
    private boolean mostrarLiberacionIft = false;
     ...
     */
    public GeneralesLiberacionNgTab(Wizard pWizard, INumeracionGeograficaService pNgService) {
        ...
        if (isValido()) {
            try {
                ...
                if (solicitud.getTipoSolicitud() == null) {
                    ...
                    tipoSol.setCdg(TipoSolicitud.LIBERACION);
