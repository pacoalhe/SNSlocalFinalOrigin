...
/**
 * Bean asociado a la solicitud de liberaciones de numeración geográfica.
 */
@ManagedBean(name = "solicitudLiberacionNgBean")
@ViewScoped
public class SolicitudLiberacionNgBean extends Wizard implements Serializable {

    /** Control Serialización. */
    private static final long serialVersionUID = 1L;

    /** Logger de la clase . */
    private static final Logger LOGGER = LoggerFactory.getLogger(SolicitudLiberacionNgBean.class);

    /** Identificador del componente de mensajes JSF. */
    private static final String MSG_ID = "MSG_Wizard_SolicitudLiberacion";
    ...
    private GeneralesLiberacionNgTab tabGenerales;

    /** Tab/Pestaña de selección de liberación de numeraciones. */
    private LiberacionesNgTab tabLiberacion;
    ...
    public SolicitudLiberacionNgBean() {
    ...
    public void init() throws Exception {
        ...
        // Pestaña 'Generales'
        tabGenerales = new GeneralesLiberacionNgTab(this, ngService);
        tabGenerales.setId("Liberación Solicitudes - TabGenerales");
        getPasosWizard().add(tabGenerales);

        // Pestaña 'Liberación'
        tabLiberacion = new LiberacionesNgTab(this, ngService);
        tabLiberacion.setId("Liberación Solicitudes - TabLiberacion");
        getPasosWizard().add(tabLiberacion);

        // Tab de Generación de Oficios
        tabGenerarOficio = new GeneracionOficiosTab(this, oficiosFacade);
        tabGenerarOficio.setId("Liberación Solicitudes - TabOficios");
        getPasosWizard().add(tabGenerarOficio);

        tabLiberacion.setRegistroPorPagina(PaginatorUtil.getRegistrosPorPagina(ngService,
    ...
    public void nuevaSolicitud() {
        try {
            ...
            this.setSolicitud(new SolicitudLiberacionNg());
     ...
     */
    public void cargarSolicitud(SolicitudLiberacionNg pSolicitud) {
        try {
            // Cargamos las dependencias Lazy (Liberaciones Solicitadas, Aplicadas y Oficios)
            SolicitudLiberacionNg solicitudLoaded = ngService.getSolicitudLiberacionEagerLoad(pSolicitud);
    ...
    public void resetTabs() {
        ...
        jsfWizard = (org.primefaces.component.wizard.Wizard) FacesContext.getCurrentInstance().getViewRoot()
                .findComponent("FORM_SolicitudLiberacion:WIZ_SolicitudLiberacion");
    ...
    /**
     * Tab/Pestaña de selección de información genérica de solicitud.
     * @return GeneralesLiberacionNgTab
     */
    public GeneralesLiberacionNgTab getTabGenerales() {
        return tabGenerales;
    }
     ...
     */
    public void setTabGenerales(GeneralesLiberacionNgTab tabGenerales) {
     ...
     */
    public LiberacionesNgTab getTabLiberacion() {
        return tabLiberacion;
    }

    /**
     * Tab/Pestaña de selección de liberación de numeraciones.
     * @param tabLiberacion TabLiberacion
     */
    public void setTabLiberacion(LiberacionesNgTab tabLiberacion) {
