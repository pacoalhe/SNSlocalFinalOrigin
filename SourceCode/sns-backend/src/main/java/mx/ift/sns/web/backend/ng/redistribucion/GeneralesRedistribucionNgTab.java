...
/** Clase de soporte para la pestaña de 'Generales' para el trámite de Redistribución NG en los Wizard. */
public class GeneralesRedistribucionNgTab extends TabWizard {

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(GeneralesRedistribucionNgTab.class);

    /** Serialización. */
    private static final long serialVersionUID = 1L;

    /** Id del campo de errores. */
    private static final String MSG_ID = "MSG_GeneralesRedist";
     ...
     */
    public GeneralesRedistribucionNgTab(Wizard pWizard, INumeracionGeograficaService pNgService) {
    ...
    public boolean isValido() {
        try {
            // Provedor Concesionario/Ambos ha de tener IDO
            ...
            // Proveedor Comercializadora ha de tener IDA
            if (solicitud.getProveedorSolicitante().getTipoProveedor().getCdg()
                    .equals(TipoProveedor.COMERCIALIZADORA)) {
        ...
        if (isValido()) {
            try {
                ...
                if (solicitud.getTipoSolicitud() == null) {
                    ...
                    tipoSol.setCdg(TipoSolicitud.REDISTRIBUCION);
                    solicitud.setTipoSolicitud(tipoSol);
                }

                // Guardamos la Solicitud
                solicitud = ngService.saveSolicitudRedistribucion((SolicitudRedistribucionNg) solicitud);
    ...
    public void actualizaCampos() {
        try {
            ...
            if (solicitud.getRedistribucionesSolicitadas() != null) {
                solicitudIniciada = (!solicitud.getRedistribucionesSolicitadas().isEmpty());
            }
