...
/** Clase de soporte para la pestaña de 'Generales' para el trámite de Redistribución NNG en los Wizard. */
public class GeneralesRedistribucionNngTab extends TabWizard {

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(GeneralesRedistribucionNngTab.class);
     ...
     */
    public GeneralesRedistribucionNngTab(Wizard pWizard, INumeracionNoGeograficaFacade pNngFacade) {
        ...
        if (isValido()) {
            try {
                ...
                if (solicitud.getTipoSolicitud() == null) {
                    ...
                    tipoSol.setCdg(TipoSolicitud.REDISTRIBUCION_NNG);
                    solicitud.setTipoSolicitud(tipoSol);
                }

                // Guardamos la Solicitud
                solicitud = nngFacade.saveSolicitudRedistribucion((SolicitudRedistribucionNng) solicitud);
