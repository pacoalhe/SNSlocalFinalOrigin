 ...
 */
public class FiltroBusquedaSolicitudesCPSI implements Serializable {

    /** Serial UID. */
    private static final long serialVersionUID = 1L;

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(FiltroBusquedaSolicitudesCPSI.class);
    ...
    /** Estado de solicitud de codigos a la UIT. */
    private EstatusSolicitudCpsiUit estatusCpsiUit;

    /** Id del cpsi. */
    private CodigoCPSI idCpsi;
     ...
     */
    public ArrayList<FiltroBusqueda> getListaFiltrosSolicitudAsignacionCpsi() {
     ...
     */
    public ArrayList<FiltroBusqueda> getListaFiltrosSolicitudLiberacionCpsi() {
        ...
        // Tabla CPSI_LIBERACION_SOLICITADA
     ...
     * @return Lista de objetos FiltroBusqueda con la información solicitada
     */
    public ArrayList<FiltroBusqueda> getListaFiltrosSolicitudCesionCpsi() {
        ArrayList<FiltroBusqueda> filtros = new ArrayList<FiltroBusqueda>();

        // Búsqueda sobre tabla CPSI_SOLICITUD_CESION -> sl
        ...
        // Búsqueda sobre tabla CPSI_CESION_SOLICITADA -> cs
        if (fechaImplementacionDesde != null) {
            try {
                FiltroBusqueda filtro = new FiltroBusqueda();
     ...
     * @return Lista de objetos FiltroBusqueda con la información solicitada
     */
    public ArrayList<FiltroBusqueda> getListaFiltrosConsultaGenericaCpsi() {
        ArrayList<FiltroBusqueda> filtros = new ArrayList<FiltroBusqueda>();
     ...
     * @throws Exception exception
     */
    public ArrayList<FiltroBusqueda> getListaFiltrosSolicitudCpsiUit() {
        ...
        // Búsqueda sobre tabla CPSI_UIT_ENTREGADO -> ce
        if (estatusCpsiUit != null) {
            FiltroBusqueda filtro = new FiltroBusqueda();
            filtro.setCampo("estatus", "ce");
            filtro.setValor(estatusCpsiUit, EstadoCesionSolicitada.class);
            filtros.add(filtro);
        }

        if (idCpsi != null) {
            FiltroBusqueda filtro = new FiltroBusqueda();
            filtro.setCampo("idCpsi", "ce");
            filtro.setValor(idCpsi.getId(), BigDecimal.class);
            filtros.add(filtro);
        }
    ...
    /**
     * Estado de solicitud de codigos a la UIT.
     * @return the estatusCpsiUit
     */
    public EstatusSolicitudCpsiUit getEstatusCpsiUit() {
        return estatusCpsiUit;
    }

    /**
     * Estado de solicitud de codigos a la UIT.
     * @param estatusCpsiUit the estatusCpsiUit to set
     */
    public void setEstatusCpsiUit(EstatusSolicitudCpsiUit estatusCpsiUit) {
        this.estatusCpsiUit = estatusCpsiUit;
    }
     ...
     * @return the idCpsi
     */
    public CodigoCPSI getIdCpsi() {
        return idCpsi;
    }

    /**
     * Id del cpsi.
     * @param idCpsi the idCpsi to set
     */
    public void setIdCpsi(CodigoCPSI idCpsi) {
        this.idCpsi = idCpsi;
    }
