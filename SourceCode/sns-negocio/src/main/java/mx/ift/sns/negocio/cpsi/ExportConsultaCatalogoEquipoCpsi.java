 ...
 * @author X23016PE
 */
public class ExportConsultaCatalogoEquipoCpsi implements IExportarExcel {
    ...
    public static final String TXT_EQUIPOS_CPSI = "Equipos de Señalizacion Internacional";
    ...
    /**
     * Constructor.
     * @param pListadoEquipos List<EquipoSenalCpsi>
     */
    public ExportConsultaCatalogoEquipoCpsi(List<EquipoSenalCpsi> pListadoEquipos) {
        this.listadoEquipos = pListadoEquipos;
    ...
    public ArrayList<ExcelCeldaInfo[]> getContenido() {
        ...
        for (EquipoSenalCpsi equipo : listadoEquipos) {
            ...
            celda = new ExcelCeldaInfo("I", ExportarExcel.ESTILO_GENERAL_WRAP, null, false);
            contenidoFila[contCelda++] = celda;
            ...
            String warnings = "";
            for (EquipoSenalCpsiWarn warn : equipo.getWarnings()) {
