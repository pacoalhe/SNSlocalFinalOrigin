...
public class EquipoCpsnExcel implements Serializable {
     ...
     */
    public EquipoCpsnExcel(List<String> columnas, boolean procesarRegistro, List<ErrorRegistro> erroresValidacion) {
