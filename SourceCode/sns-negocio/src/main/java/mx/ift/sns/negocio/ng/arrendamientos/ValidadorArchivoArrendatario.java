...
/**
 * Validacion Archivo Numeracion Arrendatario. El formato de la cabecera es: numberfrom,numberto,Arrendatario,Arrendador
 */
public class ValidadorArchivoArrendatario extends ValidadorArchivoCSV {

    /** Logger de la clase. */
    private static final Logger LOGGER = LoggerFactory.getLogger(ValidadorArchivoArrendatario.class);
    ...
    public static final int CAMPO_IDO_ARRENDATARIO = 3;

    /** Campo ido arrendador. */
    public static final int CAMPO_IDO_ARRENDADOR = 2;
